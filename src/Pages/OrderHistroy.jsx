...
const orders = [
  ...
  },
  {
    ...
    image: "https://via.placeholder.com/150/FF0000/FFFFFF?text=Product+2", // Placeholder Image
    unitPrice: "2499.00",
  ...
  },
  {
    ...
    image: "https://via.placeholder.com/150/808080/FFFFFF?text=Product+3", // Placeholder Image
    unitPrice: "899.00",
    orderDate: "2025-05-01",
    status: "Cancelled",
...
const OrderHistory = () => {
  ...
  return (
    <>
      ...
      <div>
        {/* Banner Section - Mimics the style of the provided image */}
          {/* Banner Section */}
        <div
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12 bg-gray-50">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-grow space-y-4">
              <h2 className="text-xl font-semibold text-gray-800 hidden lg:block">My Orders ({orders.length})</h2>
              
              {/* Desktop Table Header - Simplified for cards/list view responsiveness */}
      ...
      {isFilterOpen && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          {/* Drawer - Added simple transition effect */}
          <div className={`fixed top-0 right-0 h-full w-64 sm:w-80 bg-gray-50 shadow-2xl p-6 z-50 transform transition-transform duration-300 ease-in-out ${isFilterOpen ? 'translate-x-0' : 'translate-x-full'}`}>
            <button
            ...
            <h2 className="text-xl font-bold text-[#141A44] mb-6">Filter Options</h2>
            <OrderFilters />
          </div>
        </div>
      )}
